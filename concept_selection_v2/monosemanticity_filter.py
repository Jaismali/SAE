...
[Copied into concept_selection_v2/ from Concept_selection/monosemanticity_filter.py
for pipeline self-containment, same pattern as contract.py. If the
canonical Concept_selection/ copy is ever edited, this copy must be
updated too -- these are not currently kept in sync automatically.]
